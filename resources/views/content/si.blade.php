...
@section('content')
    ...
    <div class="vg-page page-contact" id="contact">
        <div class="container-fluid">
            <div class="container text-justify justify-content-center py-5 mx-25">
                ...
                {{-- kurikulum --}}
                <h4>Kurikulum</h4>
                <p>Program studi Sistem Informasi di STMIK Rosma memiliki kurikulum yang menggabungkan teori dan praktik,
                    mencakup:</p>
                <ul>
                ...
                <p>Lulusan program Sistem Informasi di STMIK Rosma memiliki peluang karier yang sangat luas. Berikut
    ...
    <section class="prodi-parallax">
        ...
        <div class="prodi-content">
            ...
            <p>Jangan lewatkan kesempatan untuk memulai perjalanan karier yang cerah dengan bergabung di program Sistem
                Informasi di STMIK Rosma!</p>
