    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
        <div class="d-flex justify-content-center">
            <div class="text-center">
                <h1 class="mx-auto my-0 text-uppercase">Sistem Informasi</h1>
            </div>
        </div>
    </div>
</header>
...
<div class="vg-page page-contact" id="contact">
    <div class="container-fluid">
        <div class="container text-justify justify-content-center py-5 mx-25">
            {{-- Visi dan Misi --}}
            <h4>Visi Program Studi Sistem Informasi</h4>
            ...
            {{-- kurikulum --}}
            <h4>Kurikulum</h4>
            <p>Program studi Sistem Informasi di STMIK Rosma memiliki kurikulum yang menggabungkan teori dan praktik, mencakup:</p>
            <ul>
            ...
            <p>Lulusan program Sistem Informasi di STMIK Rosma memiliki peluang karier yang sangat luas. Berikut beberapa posisi yang dapat dijalani:</p>
...
<section class="prodi-parallax">
    ...
    <div class="prodi-content">
        <h2>Ingin Bergabung dengan Program Sistem Informasi?</h2>
        <p>Jangan lewatkan kesempatan untuk memulai perjalanan karier yang cerah dengan bergabung di program Sistem Informasi di STMIK Rosma!</p>
...
{{-- floating button --}}
<a href="si#header" class="floating-btn" id="floatingBtn"></a>
