...
<div class="container py-5 px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center" id="persyaratan">
    <div class="d-flex justify-content-center">
        <div class="text-center">
            ...
            <p class="mt-3">Pendaftaran memiliki tiga jalur yaitu: <strong class="badge text-bg-info">Reguler</strong>, <strong class="badge text-bg-danger">Beasiswa Prestaka</strong> dan <strong class="badge text-bg-warning">Kartu Indonesia Pintar</strong>. Berikut adalah syarat yang harus kamu persiapkan</p>
        </div>
    </div>
</div>
            ...
            <div class="timeline left">
                <div class="card shadow">
                    <div class="card-body p-4">
                        <h3>1. Buat Akun</h3>
                        <p class="mb-0"> Silakan daftar akun Anda melalui tautan yang disediakan. Akun ini akan menjadi akses Anda ke berbagai layanan akademis dan administratif di institusi kami.</p>
                    </div>
                </div>
            </div>
            <div class="timeline right">
                <div class="card shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-0">Isi formulir data diri dengan rinci. Informasi yang Anda berikan akan membantu kami memproses pendaftaran Anda dengan lancar dan memberikan dukungan yang sesuai.</p>
                    </div>
                </div>
            </div>
            <div class="timeline left">
                <div class="card shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-0">Telusuri program studi yang tersedia dan pilihlah jurusan yang sesuai dengan minat dan keinginan karier Anda. Pastikan untuk mempertimbangkan keahlian dan minat Anda dalam memilih jurusan.</p>
                    </div>
                </div>
            </div>
            <div class="timeline right">
                <div class="card shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-0">Lakukan pembayaran biaya administrasi sesuai petunjuk yang tersedia. Pastikan untuk menyimpan bukti pembayaran untuk proses verifikasi dan pemrosesan pendaftaran Anda.</p>
                    </div>
                </div>
            </div>
            <div class="timeline left">
                <div class="card shadow">
                    <div class="card-body p-4">
                        <h3>5. Test Ofline</h3>
                        <p class="mb-0">Persiapkan diri Anda dengan baik untuk mengikuti tes offline yang telah dijadwalkan. Tes ini akan membantu kami menilai kemampuan dan kualifikasi Anda untuk bergabung di institusi kami.</p>
                    </div>
                </div>
            </div>
            <div class="timeline right">
                <div class="card shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="mb-0">Setelah berhasil melewati tahap seleksi, Anda akan diminta untuk melakukan daftar ulang. Pastikan Anda melengkapi semua dokumen yang diperlukan dan mengikuti prosedur daftar ulang dengan tepat.</p>
                    </div>
                </div>
            </div>
            <div class="timeline left">
                <div class="card shadow">
                    <div class="card-body p-4">
                        <h3>7. Onboarding</h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis ducimus, perspiciatis enim perferendis ipsum quod excepturi! Voluptatum magnam non eius!</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Persyaratan diserahkan saat daftar ulang dengan melakukan upload file scan melalui halaman profle</p>
                            <p>1. KTP <br> 2. Kartu Keluarga <br>3. Ijazah <br>4. Transkip Nilai <br>5. Melunasi Biaya Pendaftaran <br>6. Mengikuti Test</p>
                            <ul class="list-inline">
                                <li>
                                    <strong>Informasi:</strong>
                                    <a href="http://wa.me/625888888888" target="_blank" rel="noopener noreferrer">+62858-8888-8888</a>
                                </li>
                                <li>
                                    <strong>Email:</strong>
                            ...
                            <a class="btn text-bg-info btn-xl text-uppercase" href="{{ url('register') }}" target="_blank" rel="noopener noreferrer">Daftar Sekarang</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <a class="btn text-bg-danger btn-xl text-uppercase" href="{{ url('register') }}" target="_blank" rel="noopener noreferrer">Daftar Sekarang</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <a class="btn text-bg-warning btn-xl text-uppercase" href="{{ url('register') }}" target="_blank" rel="noopener noreferrer">Daftar Sekarang</a>
