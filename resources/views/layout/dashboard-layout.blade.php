            ...
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    @if (auth()->user() && auth()->user()->is_admin == 1)
                        ...
                        <div class="btn-group">
                            <a href="/admin/posts" type="button"
                                class="list-group-item list-group-item-action py-2 {{ request()->is('admin/posts*') ? 'active' : '' }}"
                                data-mdb-ripple-init>
                                <i class="fa-solid fa-pen-to-square fa-fw me-3"></i><span>Content</span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a type="button" href="#"
